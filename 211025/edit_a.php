...
$id = $_GET["id"]; // Lấy id từ người dùng cần sửa
$firstname = "";
$lastname = "";
$email = "";
$contact = "";

// Bước 1: Lấy dữ liệu cũ hiển thị lên form khi vừa vào trang
...
// header("location.index.php"); // sai cú pháp và vị trí. Web sẽ chuyển về index.php ngay lập tức (không vào được trang sửa)
